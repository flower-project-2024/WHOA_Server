...
import com.whoa.whoaserver.domain.bouquet.service.BouquetImageService;
...
import com.whoa.whoaserver.domain.bouquet.dto.response.PresignedUrlResponse;
...
@Tag(name = "1차 MVP Bouquet Image", description = "Header에 MEMBER_ID(key), 디바이스 등록 이후 반환 받은 id(value)로 요청해주세요.")
@RestController
